...
<span style="color: blue;">The map above using `1` as a predictor of temperature/precipitation which means that the IDW model uses spatial interpolation only. Thus, there is a lack of predictive power in areas where there is no station data collected. </span>

## Beyond spatial only interpolation
...
<span style="color: blue;">Note, the increased predictive resolution when including variation in both elevation and geographic space as predictors.</span>
...
<span style="color: blue;">The map created above using elevation as a predictor of temperature aligns well with the PRISM map and improves upon the .</span>

## Add aspect as predictor
